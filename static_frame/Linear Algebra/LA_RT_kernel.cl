__kernel void testKernel(__global float3* outputData, int widthIN, int heightIN, float3 u, float3 v, float3 w, float3 imagePlaneOrigin, float3 cameraOrigin,
 float3 lightPosition, float3 lightColour, float3 backgroundColour, float3 planeNormal, float3 planePoint, float3 planeColour,
__global float8* spheres, int numberOfSpheres
){
