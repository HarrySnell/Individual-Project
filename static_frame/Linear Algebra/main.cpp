...
int main() {
	...
	kernel.setArg(4, v);
	kernel.setArg(5, w);
	kernel.setArg(6, imagePlaneOrigin);
	kernel.setArg(7, cameraOrigin);
	kernel.setArg(8, lightPosition);
	kernel.setArg(9, lightColour);
	kernel.setArg(10, backgroundColour);
	kernel.setArg(11, planeNormal);
	kernel.setArg(12, planePoint);
	kernel.setArg(13, planeColour);
	kernel.setArg(14, spheresBuffer);
	kernel.setArg(15, numberOfSpheres);
	///////////////////////////////////////////////////////////
